...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CadastroCliente.profissao_conjuge'
        db.alter_column(u'clientes_cadastrocliente', 'profissao_conjuge', self.gf('django.db.models.fields.IntegerField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'CadastroCliente.profissao_conjuge'
        db.alter_column(u'clientes_cadastrocliente', 'profissao_conjuge', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=255, null=True))
