...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CadastroCliente.qtde_filhos'
        db.alter_column(u'clientes_cadastrocliente', 'qtde_filhos', self.gf('django.db.models.fields.IntegerField')(max_length=5, null=True))

    def backwards(self, orm):

        # Changing field 'CadastroCliente.qtde_filhos'
        db.alter_column(u'clientes_cadastrocliente', 'qtde_filhos', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=5, null=True))
