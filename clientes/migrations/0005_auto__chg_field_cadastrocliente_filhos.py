...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CadastroCliente.filhos'
        db.alter_column(u'clientes_cadastrocliente', 'filhos', self.gf('django.db.models.fields.BooleanField')())

    def backwards(self, orm):

        # Changing field 'CadastroCliente.filhos'
        db.alter_column(u'clientes_cadastrocliente', 'filhos', self.gf('django.db.models.fields.NullBooleanField')(null=True))
