...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Plantas.unidade'
        db.delete_column(u'empreendimentos_plantas', 'unidade_id')

        # Adding field 'Plantas.empreendimento'
        db.add_column(u'empreendimentos_plantas', 'empreendimento',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['empreendimentos.CadastroEmpreendimento']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Plantas.unidade'
        db.add_column(u'empreendimentos_plantas', 'unidade',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['empreendimentos.CadastroUnidade']),
                      keep_default=False)

        # Deleting field 'Plantas.empreendimento'
        db.delete_column(u'empreendimentos_plantas', 'empreendimento_id')
    ...
    models = {
        ...
        u'empreendimentos.plantas': {
            'Meta': {'ordering': "('legenda',)", 'object_name': 'Plantas'},
            'empreendimento': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['empreendimentos.CadastroEmpreendimento']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'imagem': ('django.db.models.fields.files.ImageField', [], {'max_length': '255'}),
            'legenda': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
