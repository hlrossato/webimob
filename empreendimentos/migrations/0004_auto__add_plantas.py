...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Plantas'
        db.create_table(u'empreendimentos_plantas', (
        ...
        db.send_create_signal(u'empreendimentos', ['Plantas'])


    def backwards(self, orm):
        # Deleting model 'Plantas'
        db.delete_table(u'empreendimentos_plantas')
